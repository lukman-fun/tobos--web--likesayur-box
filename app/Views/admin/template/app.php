...
<head>
  ...
  <link rel="icon" href="<?= base_url('adminui/favicon.ico'); ?>">
  <title>TOBOS | <?= $this->renderSection('title'); ?></title>
  <!-- Simple bar CSS -->
  ...
  <link rel="stylesheet" href="<?= base_url('adminui/css/select2.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('adminui/css/dropzone.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('adminui/css/uppy.min.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('adminui/css/jquery.steps.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('adminui/css/jquery.timepicker.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('adminui/css/quill.snow.css'); ?>">
  <!-- Date Range Picker CSS -->
  <link rel="stylesheet" href="<?= base_url('adminui/css/daterangepicker.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('adminui/css/dataTables.bootstrap4.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('dist/css/tobos.css'); ?>">
  <!-- App CSS -->
...
<body class="vertical  light" style="height: 90vh;">
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center mb-2">
              <div class="col">
                <h2 class="h5 page-title"><?= $this->renderSection('name_page'); ?></h2>
              </div>
              <div class="col-auto">
                <?= $this->renderSection('desc_page'); ?>
                  ...
                  <div class="card-body" data-simplebar style="height:355px; overflow-y: auto; overflow-x: hidden;">
                    ...
                    <div class="pb-3 timeline-item item-warning">
                      <div class="pl-5">
                        ...
                        <div class="row mb-3">
                          <div class="col"><img src="<?= base_url('adminui/assets/products/p1.jpg'); ?>" alt="..."
                              class="img-fluid rounded"></div>
                          <div class="col"><img src="<?= base_url('adminui/assets/products/p2.jpg'); ?>" alt="..."
                              class="img-fluid rounded"></div>
                          <div class="col"><img src="<?= base_url('adminui/assets/products/p3.jpg'); ?>" alt="..."
                              class="img-fluid rounded"></div>
                          <div class="col"><img src="<?= base_url('adminui/assets/products/p4.jpg'); ?>" alt="..."
                              class="img-fluid rounded"></div>
                        </div>
                          ...
                          <li>
                            <a href="#!" class="avatar avatar-sm">
                              <img alt="..." class="avatar-img rounded-circle"
                                src="<?= base_url('adminui/assets/avatars/face-1.jpg'); ?>">
                            </a>
                          </li>
                          <li>
                            <a href="#!" class="avatar avatar-sm">
                              <img alt="..." class="avatar-img rounded-circle"
                                src="<?= base_url('adminui/assets/avatars/face-4.jpg'); ?>">
                            </a>
                          </li>
                          <li>
                            <a href="#!" class="avatar avatar-sm">
                              <img alt="..." class="avatar-img rounded-circle"
                                src="<?= base_url('adminui/assets/avatars/face-3.jpg'); ?>">
                            </a>
                          </li>
                        </ul>
                        <p class="small text-muted">Front-End Development <span class="badge badge-light">1h ago</span>
  ...
  <script src="<?= base_url('adminui/js/d3.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/topojson.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/datamaps.all.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/datamaps-zoomto.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/datamaps.custom.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/Chart.min.js'); ?>"></script>
  <script>
    /* defind global options */
      Chart.defaults.global.defaultFontFamily = base.defaultFontFamily;
      Chart.defaults.global.defaultFontColor = colors.mutedColor;
  </script>
  <script src="<?= base_url('adminui/js/gauge.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/jquery.sparkline.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/apexcharts.min.js'); ?>"></script>
  <!-- <script src="<?= base_url('adminui/js/apexcharts.custom.js'); ?>"></script> -->
  <script src="<?= base_url('adminui/js/jquery.mask.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/select2.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/jquery.steps.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/jquery.validate.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/jquery.timepicker.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/dropzone.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/uppy.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/quill.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/jquery.dataTables.min.js'); ?>"></script>
  <script src="<?= base_url('adminui/js/dataTables.bootstrap4.min.js'); ?>"></script>
  ...
  <script type="text/javascript">
    ...
    window.admin_url = window.base_url + '/admin/';
    window.api_url = window.admin_url + 'api/';
  </script>
